        ...
        if (sim.run) {
          ...
          // in-sync: step until ahead of cpu
            ...
            while (Seconds((d->time - syncSim)*slowdown) < mj::Simulate::Clock::now() - syncCPU &&
              ...
              ///////////////////////////////////////////
              // 更新相机位置
              int camera_body_id = m->body_mocapid[mj_name2id(m, mjOBJ_BODY, "camera")];
              mjtNum* camera_pos = &(d->mocap_pos[camera_body_id]);

              static int i = 0;
              camera_pos[1] = sin(i / 60.0);
              i++;
              //////////////////////////////////////////
...
{
  pcl::visualization::PCLVisualizer::Ptr viewer = color_cloud_visual(mujoco::color_cloud);

  bool INIT = true;
  while(!viewer->wasStopped() )
  {
    mujoco::myMtx.lock();
    viewer->updatePointCloud(mujoco::color_cloud, "cloud");
    mujoco::myMtx.unlock();
